        ...
        <div className="relative border-0 border-red-500 sm1:hidden md:block h-[50rem]">
          <div className="w-4/5 pt-20 m-auto border-0 border-red-500 opacity-1" id="main">
            <div className="z-0 text-2xl font-normal tracking-tighter text-white border-0 border-red-500 font-change2">
              ...
              <span className="text-blue-400 border-0 border-red-500 absolute top-[16.5rem] xl:left-[20.8rem] lg:left-[17.5rem] md:left-[14.2rem]">&nbsp;Ali Faiz</span>
            </div>
            <div className="absolute z-10 font-extrabold tracking-tighter text-white lg:text-8xl xl:text-9xl font-change2 top-[20rem] md:text-7xl sm3:text-7xl">I'm a Business</div>
            <div className="z-30 font-extrabold tracking-tighter text-white lg:text-8xl xl:text-9xl font-change2 font-stencil2 top-[20rem] absolute md:text-7xl sm3:text-7xl">I'm a Business</div>
            <div className="absolute z-10 font-extrabold tracking-tighter text-white lg:text-8xl xl:text-9xl font-change2 xl:top-[28rem] md:top-[25rem] lg:top-[26rem] md:text-7xl sm3:text-7xl"><span className="text-blue-400/30 font-stencil23">Dev</span><span className="sm1:block md:inline">eloper / Marketer</span></div>
            <div className="absolute z-30 font-extrabold tracking-tighter text-white lg:text-8xl xl:text-9xl font-change2 font-stencil2 md:top-[25rem] xl:top-[27.95rem] lg:top-[26rem] md:text-7xl sm3:text-7xl"><span className="text-blue-400/30 font-stencil23">Dev</span><span className="sm1:block md:inline">eloper / Marketer</span></div>
          </div>
          <motion.div style={{ x: toRight2 }} className="top-[12rem] absolute text-blue-400/50 overflow-hidden whitespace-nowrap font-stencil24 text-6xl font-extrabold">
...
<motion.div style={{ x: toRight2 }} className="top-[15rem] absolute text-blue-400/50 overflow-hidden whitespace-nowrap font-stencil24 text-6xl font-extrabold">
  marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing
</motion.div>
<motion.div style={{ x: toRight2 }} className="top-[18rem] absolute text-blue-400/50 overflow-hidden whitespace-nowrap font-stencil24 text-6xl font-extrabold">
  marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing
</motion.div>
<motion.div style={{ x: toRight2 }} className="top-[21rem] absolute text-blue-400/50 overflow-hidden whitespace-nowrap font-stencil24 text-6xl font-extrabold">
  marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing marketing
</motion.div>
...
<div className="absolute w-4/5 m-auto border-0 border-red-500 top-[-4rem] lg:left-[9rem] xl:left-[10rem] md:left-[5rem] z-20">
 ...
 <div className="absolute z-30 flex space-x-3 lg:top-[35rem] xl:top-[38rem] md:right-8 xl:right-[10rem] md:top-[31rem]">
            ...
            <a href="https://www.linkedin.com/in/ali-faiz-rizvi-6879631a3/" target="_blank" rel="noreferrer">
            ...
            <a href="https://www.instagram.com/_alifaiz_/" target="_blank" rel="noreferrer" >
...
<motion.div style={{ x: toRight2 }} className="top-[33rem] absolute text-white/50 overflow-hidden whitespace-nowrap font-stencil24 text-6xl font-extrabold">
  ...
  <div className="relative z-10 w-full m-auto -ml-4 border-0 border-red-500">
          ...
          <div className="absolute z-40 w-11/12 text-sm text-white border-0 border-red-500 top-[28rem] sm3:left-[2rem] sm1:left-[1rem] sm1:hidden">Hello,I&apos;m <span className="font-bold text-blue-400">Ali Faiz</span>,a passionate <span className="font-bold text-blue-400">Marketing & International Business Developer</span> driven to solve complex problems and deliver innovative, real-world solutions.</div>
